...
public class Player extends Entity{
    ...
    ArrayList<SuperObject> inventory = new ArrayList<SuperObject>();
                ...
                case "Door":
                    for(SuperObject item : inventory){
                        if(item.name.equals("Key")){
                            if(item.type.equals(gp.obj[i].type)){
                                ...
                                System.out.print("Inventory: ");
                                for(SuperObject it : inventory){
                                    System.out.print(it.type + " " + it.name + ", ");
                                }
                                System.out.println();
                                break;
                            }
                    ...
                    if(!hasKey){
                        System.out.println("You don't have the key to this door.");
                    }
                    break;
                    ...
                    for(SuperObject item : inventory){
                        if(item.name.equals("Key")){
                            if(item.type.equals(gp.obj[i].type)){
                                ...
                                System.out.println("+100000 Aura");
